...
# Parameters
language <- 0 # 0: spanish, 1:basque, 2:english
...
# TODO: hacer una secuencia en R para ver si hay otras id de datos no publicadas
...
# To download data in Spanish you need to change the variable in the URL to 0: language1=0, if you want them in english, use 2: language1=2if ( !file.exists("Adierazleak udalerrika.html")  |
...
library(maptools) #sometimes "fortify" is not working,
